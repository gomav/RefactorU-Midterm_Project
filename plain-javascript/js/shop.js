	...
	Shop.prototype = {
	  init: function() {
		// Properties
			...
			this.paypalBusinessEmail = "info@sazonsr.com"; // Your Business PayPal's account email address
		...
		handleAddToCartForm: function() {
			...
			for( var i = 0; i < self.formAddToCart.length; ++i ) {
				...
				var price = self._convertString( product.getAttribute( "item-price" ) );
				var name =  product.getAttribute( "menu-title" );
